 ...
 */
package projek_4_tambahan_perulangan;
...
public class Projek_4_tambahan_perulangan {
private static boolean indexbatas_perulangan;
    
    
    public static  void main (String args []) throws Exception{ //2.buatkan fungsi utama
    ...
    int index=0,
     ...
     //tambahan perulangan ..
     //sebelum input data lakukan perintah untuk perulangan terhadap
     //banyak data yang akan di input
     System.out.println("masukkan banyak data");
         batas_perulangan = Integer.valueOf(in.readLine());
       //perintah perulangannya
         
         for(index=0; index<batas_perulangan;index++ ){
