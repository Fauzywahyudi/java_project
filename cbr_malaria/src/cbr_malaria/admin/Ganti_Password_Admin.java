 ...
 */
public class Ganti_Password_Admin extends javax.swing.JFrame {
    ...
    public Ganti_Password_Admin(Admin user) {
        initComponents();
        koneksiDB();
        userData = user;
        ...
        if (_passLama.equals("") || _passBaru.equals("")) {
            ...
            if (_passLama.equals(userData.getPassword())) {
                try {
                    ...
                    st.executeUpdate("UPDATE tb_admin SET password='" + _passBaru + "' WHERE id_admin='" + idUser + "'");
    ...
    public void kembali(String password){
        try {
    ...
    public static void main(final Admin user) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ganti_Password_Admin(user).setVisible(true);
            }
        });
    }
